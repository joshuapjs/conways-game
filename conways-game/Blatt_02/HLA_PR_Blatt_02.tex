...
\subsection*{Exercise 1.1: Design of the Cellular Automaton}
	...
	Our implementation follows an object-oriented approach with two main classes: \textit{World Class} (\texttt{World.h, World.cpp}) and \textit{CLI Class} (\texttt{Cli.h, Cli.cpp}). The \textit{World Class} manages the cellular automaton's state and evolution logic and the \textit{CLI Class} handles user interaction and command parsing.
